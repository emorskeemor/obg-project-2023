...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='block',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='block_subjects', to='generator.block'),
        ),
        migrations.AddField(
            model_name='blocksubject',
            name='option',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='block_subjects', to='students.option'),
        ),
        migrations.AddField(
            model_name='block',
            name='blocks',
        ...
        migrations.AddField(
            model_name='block',
            name='options',
            field=models.ManyToManyField(related_name='options', through='generator.BlockSubject', to='students.Option', verbose_name='options connected to the block'),
        ),
